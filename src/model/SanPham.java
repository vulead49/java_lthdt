...
public class SanPham {
	...
	public SanPham(String maSanPham, String tenSanPham, String soLuongSanPham, String loaiSanPham, String maNhaCungCap,
	...
	public boolean equals(Object obj) {
		...
		return Double.doubleToLongBits(giaTienSanPham) == Double.doubleToLongBits(other.giaTienSanPham)
				&& Objects.equals(loaiSanPham, other.loaiSanPham) && Objects.equals(maNhaCungCap, other.maNhaCungCap)
				&& Objects.equals(maSanPham, other.maSanPham) && Objects.equals(soLuongSanPham, other.soLuongSanPham)
	...
	public String toString() {
		return "SanPham [maSanPham=" + maSanPham + ", tenSanPham=" + tenSanPham + ", soLuongSanPham=" + soLuongSanPham
				+ ", loaiSanPham=" + loaiSanPham + ", maNhaCungCap=" + maNhaCungCap + ", giaTienSanPham="
				+ giaTienSanPham + "]";
	}
